...
namespace 轨迹数据预处理
{
    ...
    class Program
    {
        ...
        static void GetDataOfEachCentoid()
        {
            ...
            IFeatureSet centroid = FeatureSet.Open(@"D:\MagicSong\OneDrive\2017研究生毕业设计\数据\项目用数据\newCentroid.shp");
            IFeatureSet LargePoints = FeatureSet.Open(@"D:\MagicSong\OneDrive\2017研究生毕业设计\数据\项目用数据\OriginalGauss.shp");
            sw.Stop();
